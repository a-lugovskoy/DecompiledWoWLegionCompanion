...
public class iTween : MonoBehaviour
{
	...
	private void GenerateTargets()
	{
		...
		if (text != null)
		{
			if (iTween.<>f__switch$map19 == null)
			{
				...
				iTween.<>f__switch$map19 = dictionary;
			}
			int num;
			if (iTween.<>f__switch$map19.TryGetValue(text, ref num))
			{
				switch (num)
				{
				case 0:
				{
					...
					if (text2 != null)
					{
						...
						int num2;
						if (iTween.<>f__switch$map10.TryGetValue(text2, ref num2))
						{
							switch (num2)
							{
							case 0:
				...
				case 1:
				{
					...
					if (text2 != null)
					{
						...
						int num2;
						if (iTween.<>f__switch$map11.TryGetValue(text2, ref num2))
						{
							if (num2 == 0)
							{
				...
				case 2:
				{
					...
					if (text2 != null)
					{
						...
						int num2;
						if (iTween.<>f__switch$map12.TryGetValue(text2, ref num2))
						{
							if (num2 == 0)
							{
				...
				case 3:
				{
					...
					if (text2 != null)
					{
						if (iTween.<>f__switch$map13 == null)
						{
							...
							iTween.<>f__switch$map13 = dictionary;
						}
						int num2;
						if (iTween.<>f__switch$map13.TryGetValue(text2, ref num2))
						{
							if (num2 != 0)
							{
								if (num2 == 1)
				...
				case 4:
				{
					...
					if (text2 != null)
					{
						if (iTween.<>f__switch$map14 == null)
						{
							...
							iTween.<>f__switch$map14 = dictionary;
						}
						int num2;
						if (iTween.<>f__switch$map14.TryGetValue(text2, ref num2))
						{
							switch (num2)
							{
							case 0:
				...
				case 5:
				{
					...
					if (text2 != null)
					{
						if (iTween.<>f__switch$map15 == null)
						{
							...
							dictionary.Add("add", 1);
							dictionary.Add("by", 2);
							iTween.<>f__switch$map15 = dictionary;
						}
						int num2;
						if (iTween.<>f__switch$map15.TryGetValue(text2, ref num2))
						{
							switch (num2)
							{
							case 0:
				...
				case 6:
				{
					...
					if (text2 != null)
					{
						if (iTween.<>f__switch$map16 == null)
						{
							...
							iTween.<>f__switch$map16 = dictionary;
						}
						int num2;
						if (iTween.<>f__switch$map16.TryGetValue(text2, ref num2))
						{
							switch (num2)
							{
							case 0:
				...
				case 7:
				{
					...
					if (text2 != null)
					{
						if (iTween.<>f__switch$map17 == null)
						{
							...
							iTween.<>f__switch$map17 = dictionary;
						}
						int num2;
						if (iTween.<>f__switch$map17.TryGetValue(text2, ref num2))
						{
							switch (num2)
							{
							case 0:
				...
				case 8:
				{
					...
					if (text2 != null)
					{
						if (iTween.<>f__switch$map18 == null)
						{
							Dictionary<string, int> dictionary = new Dictionary<string, int>(1);
							dictionary.Add("to", 0);
							iTween.<>f__switch$map18 = dictionary;
						}
						int num2;
						if (iTween.<>f__switch$map18.TryGetValue(text2, ref num2))
						{
							if (num2 == 0)
							{
		...
		if (this.tweenArguments.Contains("axis"))
		{
			...
			if (text != null)
			{
				if (iTween.<>f__switch$map1A == null)
				{
					...
					dictionary.Add("y", 1);
					dictionary.Add("z", 2);
					iTween.<>f__switch$map1A = dictionary;
				}
				int num;
				if (iTween.<>f__switch$map1A.TryGetValue(text, ref num))
				{
					switch (num)
					{
					case 0:
	...
	{
		this.delayStarted = Time.get_time();
			...
			if (args.Contains("axis"))
			{
				...
				if (text != null)
				{
					if (iTween.<>f__switch$map1B == null)
					{
						...
						dictionary.Add("y", 1);
						dictionary.Add("z", 2);
						iTween.<>f__switch$map1B = dictionary;
					}
					int num2;
					if (iTween.<>f__switch$map1B.TryGetValue(text, ref num2))
					{
						switch (num2)
						{
						case 0:
	...
	{
		using (List<Hashtable>.Enumerator enumerator = iTween.tweens.GetEnumerator())
		{
			while (enumerator.MoveNext())
			{
				Hashtable current = enumerator.get_Current();
				if ((GameObject)current.get_Item("target") == base.get_gameObject())
				{
