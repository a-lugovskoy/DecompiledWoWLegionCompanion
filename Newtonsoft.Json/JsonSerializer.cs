	...
	public class JsonSerializer
	{
		...
		public static JsonSerializer Create(JsonSerializerSettings settings)
		{
			...
			if (settings != null)
			{
				...
				{
					JsonSerializer expr_B1 = jsonSerializer;
					expr_B1.Error = (EventHandler<ErrorEventArgs>)Delegate.Combine(expr_B1.Error, settings.Error);
				}
		...
		internal static JsonConverter GetMatchingConverter(IList<JsonConverter> converters, Type objectType)
		{
			...
			if (converters != null)
			{
				for (int i = 0; i < converters.get_Count(); i++)
				{
					JsonConverter jsonConverter = converters.get_Item(i);
