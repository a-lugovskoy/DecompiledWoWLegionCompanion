...
namespace WowStaticData
{
	public class UiTextureAtlasMemberDB
	{
		...
		{
			return (UiTextureAtlasMemberRec)this.m_records.get_Item(id);
		}
		...
		public void EnumRecords(Predicate<UiTextureAtlasMemberRec> callback)
		{
			...
			try
			{
				...
				{
					UiTextureAtlasMemberRec uiTextureAtlasMemberRec = (UiTextureAtlasMemberRec)enumerator.get_Current();
					if (!callback.Invoke(uiTextureAtlasMemberRec))
					{
						break;
					}
				}
		...
		public void EnumRecordsByParentID(int parentID, Predicate<UiTextureAtlasMemberRec> callback)
		{
			...
			try
			{
				...
				{
					UiTextureAtlasMemberRec uiTextureAtlasMemberRec = (UiTextureAtlasMemberRec)enumerator.get_Current();
					if ((ulong)uiTextureAtlasMemberRec.UiTextureAtlasID == (ulong)((long)parentID) && !callback.Invoke(uiTextureAtlasMemberRec))
					{
						break;
					}
				}
