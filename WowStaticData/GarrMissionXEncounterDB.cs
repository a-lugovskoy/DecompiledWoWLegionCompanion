...
namespace WowStaticData
{
	public class GarrMissionXEncounterDB
	{
		...
		{
			return (GarrMissionXEncounterRec)this.m_records.get_Item(id);
		}
		...
		public void EnumRecords(Predicate<GarrMissionXEncounterRec> callback)
		{
			...
			try
			{
				...
				{
					GarrMissionXEncounterRec garrMissionXEncounterRec = (GarrMissionXEncounterRec)enumerator.get_Current();
					if (!callback.Invoke(garrMissionXEncounterRec))
					{
						break;
					}
				}
		...
		public void EnumRecordsByParentID(int parentID, Predicate<GarrMissionXEncounterRec> callback)
		{
			...
			try
			{
				...
				{
					GarrMissionXEncounterRec garrMissionXEncounterRec = (GarrMissionXEncounterRec)enumerator.get_Current();
					if ((ulong)garrMissionXEncounterRec.GarrMissionID == (ulong)((long)parentID) && !callback.Invoke(garrMissionXEncounterRec))
					{
						break;
					}
				}
