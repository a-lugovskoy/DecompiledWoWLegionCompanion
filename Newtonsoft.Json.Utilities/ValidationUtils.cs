...
namespace Newtonsoft.Json.Utilities
{
	internal static class ValidationUtils
	{
		...
		public static void ArgumentNotNullOrEmpty(string value, string parameterName)
		{
			...
			{
				throw new ArgumentException("'{0}' cannot be empty.".FormatWith(CultureInfo.get_InvariantCulture(), new object[]
				{
					parameterName
				}), parameterName);
			}
		...
		public static void ArgumentNotNullOrEmptyOrWhitespace(string value, string parameterName)
		{
			...
			{
				throw new ArgumentException("'{0}' cannot only be whitespace.".FormatWith(CultureInfo.get_InvariantCulture(), new object[]
				{
					parameterName
				}), parameterName);
			}
		...
		public static void ArgumentTypeIsEnum(Type enumType, string parameterName)
		{
			...
			{
				throw new ArgumentException("Type {0} is not an Enum.".FormatWith(CultureInfo.get_InvariantCulture(), new object[]
				{
					enumType
				}), parameterName);
			}
		...
		{
			ValidationUtils.ArgumentNotNullOrEmpty<T>(collection, parameterName, "Collection '{0}' cannot be empty.".FormatWith(CultureInfo.get_InvariantCulture(), new object[]
			{
				parameterName
			}));
		}
		...
		{
			ValidationUtils.ArgumentNotNullOrEmpty(collection, parameterName, "Collection '{0}' cannot be empty.".FormatWith(CultureInfo.get_InvariantCulture(), new object[]
			{
				parameterName
			}));
		}
		...
		public static void ObjectNotDisposed(bool disposed, Type objectType)
		{
			if (disposed)
			{
				throw new ObjectDisposedException(objectType.get_Name());
			}
		}
