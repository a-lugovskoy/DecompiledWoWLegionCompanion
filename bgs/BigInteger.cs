	...
	public class BigInteger
	{
		...
		public string ToString(int radix)
		{
			...
			while (bigInteger.m_digits.DataUsed > 1 || (bigInteger.m_digits.DataUsed == 1 && bigInteger.m_digits[0] != 0u))
			{
				...
				arrayList.Insert(0, "0123456789abcdefghijklmnopqrstuvwxyz".get_Chars((int)bigInteger3.m_digits[0]));
				bigInteger = bigInteger2;
			}
		...
		public string ToHexString()
		{
			...
			string text = "{0:X" + 2 * DigitsArray.DataSizeOf + "}";
			for (int i = this.m_digits.DataUsed - 2; i >= 0; i--)
			{
				stringBuilder.AppendFormat(text, this.m_digits[i]);
			}
		...
		public static int ToInt16(BigInteger value)
		{
			...
			return (int)short.Parse(value.ToString(), 7, CultureInfo.get_CurrentCulture());
		}
		...
		public static uint ToUInt16(BigInteger value)
		{
			...
			return (uint)ushort.Parse(value.ToString(), 7, CultureInfo.get_CurrentCulture());
		}
		...
		public static int ToInt32(BigInteger value)
		{
			...
			return int.Parse(value.ToString(), 7, CultureInfo.get_CurrentCulture());
		}
		...
		public static uint ToUInt32(BigInteger value)
		{
			...
			return uint.Parse(value.ToString(), 7, CultureInfo.get_CurrentCulture());
		}
		...
		public static long ToInt64(BigInteger value)
		{
			...
			return long.Parse(value.ToString(), 7, CultureInfo.get_CurrentCulture());
		}
		...
		public static ulong ToUInt64(BigInteger value)
		{
			...
			return ulong.Parse(value.ToString(), 7, CultureInfo.get_CurrentCulture());
		}
