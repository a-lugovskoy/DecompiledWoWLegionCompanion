...
namespace bnet.protocol.account
{
	public class IsIgrAddressRequest : IProtoBuf
	{
		...
		public static void Serialize(Stream stream, IsIgrAddressRequest instance)
		{
			...
			{
				stream.WriteByte(10);
				ProtocolParser.WriteBytes(stream, Encoding.get_UTF8().GetBytes(instance.ClientAddress));
			}
		...
		public uint GetSerializedSize()
		{
			...
			{
				num += 1u;
				uint byteCount = (uint)Encoding.get_UTF8().GetByteCount(this.ClientAddress);
